...
<body>
	...
	<form action="Servlet?action=update" method="post">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td>类型：<select name="bookTypeID">
						<c:forEach items="${listType}" var="p">
							<option ${book.bookType.typeid eq p.typeid?"selected":"" } value = "${p.typeid} ">${p.typeName}</option>
						</c:forEach>
				</select><br />
				</td>
			</tr>
			...
			<tr>
				<td><input type="submit" value="保存" /> <a
					href="Servlet?action=query"><input type="button" value="返回" /></a>
				</td>
			</tr>
		</table>
	</form>
